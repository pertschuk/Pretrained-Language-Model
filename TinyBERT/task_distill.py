...
class MSMarcoProcessor(DataProcessor):
  ...
  def _create_example(self, text_a, text_b, label, set, guid):
    """Creates examples for the training and dev sets."""
    return InputExample(guid=set + str(guid), text_a=text_a, text_b=text_b, label=label)
...
def main():
  ...
  default_params = {
    ...
    "msmarco" : {"num_train_epochs": 1, "max_seq_length": 128}
  }

  acc_tasks = ["mnli", "mrpc", "sst-2", "qqp", "qnli", "rte", "msmarco"]
  corr_tasks = ["sts-b"]
  mcc_tasks = ["cola"]
